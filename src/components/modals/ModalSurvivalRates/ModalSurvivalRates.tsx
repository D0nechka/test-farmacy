...
interface ModalSurvivalRatesProps {
  active: boolean;
  setActive: React.Dispatch<React.SetStateAction<boolean>>;
}

export const ModalSurvivalRates = ({ active, setActive, }: ModalSurvivalRatesProps) => {
  return(
      ...
      <div className={cls.modal} onClick={e => e.stopPropagation()}>
        <div className={cls.textBlock}>
          ...
          <div className={cls.defaultTxt}>
            ...
            <sup>2</sup> Прогноз после обострений ХОБЛ схож с таковым при сердечной недостаточности,
