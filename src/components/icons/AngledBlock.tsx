...
export const AngledBlock = () => {
  return (
    <svg width="297" height="116" viewBox="0 0 297 116" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M0 114.5H254.139L295 50.5L254.139 1" stroke="url(#paint1_linear_0_5998)" strokeWidth="3"/>
      <defs>
        <linearGradient id="paint0_linear_0_5998" x1="295" y1="50.7293" x2="2.95041e-07" y2="50.7293" gradientUnits="userSpaceOnUse">
          <stop stopColor="#D8EFFF"/>
          <stop offset="1" stopColor="white"/>
        </linearGradient>
        <linearGradient id="paint1_linear_0_5998" x1="295" y1="1.00001" x2="-10.2769" y2="66.874" gradientUnits="userSpaceOnUse">
